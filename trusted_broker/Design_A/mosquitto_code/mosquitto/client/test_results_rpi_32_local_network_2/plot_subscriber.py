...
# List of file names
file_names = [
    path + "time_results_subscriber_d2_local.txt",
    path + "time_results_subscriber_d3_local.txt",
    path + "time_results_subscriber_d5_local.txt",
    path + "time_results_subscriber_f512_local.txt",
    path + "time_results_subscriber_f1024_local.txt"
]
...
for file_name in file_names:
    ...
    algorithm_name = re.search(r'_subscriber_(\w+)_local', file_name).group(1)
    with open(file_name, 'r') as file:
        ...
        print(average_decode_pk, 'PK decode')
