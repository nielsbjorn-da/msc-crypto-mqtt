...
# List of file names
file_names = [
    path + "time_results_publisher_d2.txt",
    path + "time_results_publisher_d3.txt",
    path + "time_results_publisher_d5.txt",
    path + "time_results_publisher_f512.txt",
    path + "time_results_publisher_f1024.txt"
]
...
plt.title('Publisher 32-bit - Design B Local')
