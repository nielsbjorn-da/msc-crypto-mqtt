...
path = 'Design_B/mosquitto_code/mosquitto/client/test_results_rpi_32_local/'

# List of file names
file_names = [
    path + "time_results_subscriber_d2.txt",
    path + "time_results_subscriber_d3.txt",
    path + "time_results_subscriber_d5.txt",
    path + "time_results_subscriber_f512.txt",
    path + "time_results_subscriber_f1024.txt"
]
...
plt.title('Subscriber 32-bit - Design B Local')
